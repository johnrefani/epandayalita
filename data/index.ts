...
export const footerLinks = [
  {
    ...
    links: [
      { id: 1, title: "Tungkol sa Amin  ", href: "/tungkol" },
      {
        ...
        href: "/patakaransapagkapribado",
      },
      {
        id: 3,
        title: "Mga Tuntunin ng Paggamit",
        href: "/mgatuntuninngpaggamit",
      },
    ],
  },
  {
    ...
    contacts: [
      {
        id: 1,
        title: "info@pandayalitadictionary.com",
        href: "mailto:info@pandayalitadictionary.com",
      },
...
export const source = [
  // PROSESO
  { id: 60, name: "Parakaluban", category: "PROSESO", link: "https://youtu.be/XerFnYh2C74?si=Gbuz6HFnsxcp68_J" },
  { id: 61, name: "Paratais", category: "PROSESO", link: "https://youtu.be/wK0jauE7i4Y?si=FH62M57uc1kmoFsA" },
  { id: 56, name: "Paramaso", category: "PROSESO", link: "https://youtu.be/xr8TQfBC0EY?si=XCwh2HFUGAKtlkiw" },

  // MGA PRODUKTO
  { id: 63, name: "Asada", category: "MGA PRODUKTO", link: "https://sl.bing.net/fwnfHd2zXYO" },
  { id: 83, name: "Samurai", category: "MGA PRODUKTO", link: "https://sl.bing.net/kyrvnDffFvM" },
  { id: 74, name: "Karet", category: "MGA PRODUKTO", link: "https://images.app.goo.gl/QGdVZZ2YpirCH5sW9" },
  { id: 79, name: "Palawan", category: "MGA PRODUKTO", link: "https://images.app.goo.gl/QuLWpWgKBU2R2CGZ9" },
  { id: 67, name: "Cleaver", category: "MGA PRODUKTO", link: "https://sl.bing.net/kbVeGoCNFF6" },
  { id: 86, name: "Suyod", category: "MGA PRODUKTO", link: "https://sl.bing.net/gDM4QE6W7e8" },
  { id: 84, name: "Sinampalok", category: "MGA PRODUKTO", link: "https://www./pinoybladehunter/posts/2-sinampaloktop-/2105825606387289/" },
  { id: 85, name: "Sungot-hipon", category: "MGA PRODUKTO", link: "https://images.app.goo.gl/eQZCxF22JwYy87iv8" },
  { id: 70, name: "Ginunting", category: "MGA PRODUKTO", link: "https://www.traditionalfilipinoweapons.com/ginunting/" },
  { id: 73, name: "Kaluban", category: "MGA PRODUKTO", link: "https://www.facebook.com/p/ItakKalubanPulo-made-to-order-100086190476525/" },
  { id: 62, name: "Arado", category: "MGA PRODUKTO", link: "https://commons.wikimedia.org/wiki/File:Arado_secular.JPG" },
  { id: 77, name: "Minasbad", category: "MGA PRODUKTO", link: "https://sl.bing.net/cnNoNUPnCbQ" },
  { id: 78, name: "Palakol", category: "MGA PRODUKTO", link: "https://sl.bing.net/eAKu8ne2sOy" },

  // MGA KAGAMITAN AT MATERYALES
  { id: 14, name: "Kikil", category: "MGA KAGAMITAN AT MATERYALES", link: "https://images.app.goo.gl/SeqSWGxfQq89w9CE8" },
  { id: 17, name: "Langis", category: "MGA KAGAMITAN AT MATERYALES", link: "https://sl.bing.net/gfZaJCKVhlY" },
  { id: 4, name: "Blower", category: "MGA KAGAMITAN AT MATERYALES", link: "https://www.google.com/search?q=blower+=img#vhid=nU1zyQZIfB2V0M&/" },
  { id: 10, name: "Hasaan", category: "MGA KAGAMITAN AT MATERYALES", link: "https://images.app.goo.gl/AZK8t4esuYVbkaGD8" },
  { id: 29, name: "Pliers", category: "MGA KAGAMITAN AT MATERYALES", link: "https://images.pliersl/AZK8t4esuYVbkaGD8" },
  { id: 1, name: "Anvil", category: "MGA KAGAMITAN AT MATERYALES", link: "https://images.anvil/f8LUA16nopQtgmHe8" },
  { id: 41, name: "Varnish", category: "MGA KAGAMITAN AT MATERYALES", link: "https://images.app.goo.gl/qaJnTTby73EqDzEV6" },
  { id: 8, name: "Grinder", category: "MGA KAGAMITAN AT MATERYALES", link: "https://sl.bing.net/eNTAq0zpXR6" },
  { id: 13, name: "Kibal", category: "MGA KAGAMITAN AT MATERYALES", link: "https://sl.bing.net/kyCi6WKcmT6" },
  { id: 16, name: "Lagari sa kahoy", category: "MGA KAGAMITAN AT MATERYALES", link: "https://sl.bing.net/fLi0WQqjBHE" },

  // MGA BAHAGI
  { id: 92, name: "Polo ng pala", category: "MGA BAHAGI", link: "https://sl.bing.net/gwYNcD4xzwG" },
];