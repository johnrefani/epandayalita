  ...
  return (
    <main className="overflow-hidden">
      ...
      <div className="flex-center py-9 bg-blue-800 -mx-[1rem] md:-mx-[3.75rem] lg:-mx-[6.25rem] xl:-mx-[7.5rem] mt-16 md:mt-20">
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-50 text-center">Impormasyon ng Tagapayo</h1>
      </div>

      {Information.filter((person) => person.id === 3).map((person) => (
