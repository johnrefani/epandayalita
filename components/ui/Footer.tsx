  ...
  return (
    <footer className="w-full bg-green-700 px-4 md:px-16 lg:px-24 py-16 text-white">
      <div className="place-items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-x-5 gap-y-8">
          {/* Logo */}
          <div className="relative w-52 min-h-28 justify-self-center md:justify-self-start col-span-3">
            <Image
